    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      >
        ...
        <Grid container spacing={3} alignItems="end">
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            <FormControl fullWidth>
              <InputLabel sx={{ fontSize: "1rem", fontWeight: "500" }}>Select Field to Search</InputLabel>
              <Select
                value={searchField}
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  {...params}
                  fullWidth
                  placeholder={`Type to search ${searchField === "all" ? "all fields" : searchField}...`}
                  InputProps={{
                    ...params.InputProps,
                    startAdornment: (
                      <InputAdornment position="start">
        ...
        {globalSearch && (
          <Box sx={{ mt: 3 }}>
            <Chip
              label={`🔍 Searching: "${globalSearch}" in ${searchField === "all" ? "all fields" : searchField}`}
              onDelete={() => setGlobalSearch("")}
              color="primary"
              variant="filled"
              sx={{
      ...
      >
        ...
        <Grid container spacing={3} alignItems="end">
          ...
          <Grid item xs={12} sm={6} md={2.4}>
            ...
            <FormControl fullWidth>
              <InputLabel sx={{ fontSize: "1rem", fontWeight: "500" }}>Choose Filter Field</InputLabel>
              <Select
                value={filterBy}
                label="Choose Filter Field"
              ...
              >
                ...
                <MenuItem value="title">🎵 Filter by Title</MenuItem>
                <MenuItem value="artist">👤 Filter by Artist</MenuItem>
                <MenuItem value="album">💿 Filter by Album</MenuItem>
                <MenuItem value="genre">🎼 Filter by Genre</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={2.4}>
            ...
            <FormControl fullWidth>
              <InputLabel sx={{ fontSize: "1rem", fontWeight: "500" }}>Choose Sort Field</InputLabel>
              <Select
                value={sortBy}
                label="Choose Sort Field"
              ...
              >
                ...
                <MenuItem value="genre">🎼 Sort by Genre</MenuItem>
                <MenuItem value="duration">⏱️ Sort by Duration</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={2.4}>
            ...
            <FormControl fullWidth>
              <InputLabel sx={{ fontSize: "1rem", fontWeight: "500" }}>Choose Sort Order</InputLabel>
              <Select
                value={sortOrder}
          ...
          <Grid item xs={12} sm={6} md={2.4}>
            ...
            <FormControl fullWidth>
              <InputLabel sx={{ fontSize: "1rem", fontWeight: "500" }}>Choose Group Field</InputLabel>
              <Select
                value={groupBy}
                label="Choose Group Field"
              ...
              >
                ...
                <MenuItem value="artist">👤 Group by Artist</MenuItem>
                <MenuItem value="album">💿 Group by Album</MenuItem>
                <MenuItem value="genre">🎼 Group by Genre</MenuItem>
              </Select>
            </FormControl>
          </Grid>
        </Grid>
